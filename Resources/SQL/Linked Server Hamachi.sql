...
/****** Object:  LinkedServer [S1]    Script Date: 31/05/2019 11:29:25 ******/
EXEC master.dbo.sp_addlinkedserver @server = N'S1', @srvproduct=N'SQLSRV', @provider=N'SQLNCLI', @datasrc=N'25.19.146.81\REDMI'
...
/****** Object:  LinkedServer [S2]    Script Date: 31/05/2019 11:30:51 ******/
EXEC master.dbo.sp_addlinkedserver @server = N'S2', @srvproduct=N'SQLSRV', @provider=N'SQLNCLI', @datasrc=N'25.3.56.100\VITE'
 /* For security reasons the linked server remote logins password is changed with ######## */
...
/****** Object:  LinkedServer [S3]    Script Date: 31/05/2019 11:31:46 ******/
EXEC master.dbo.sp_addlinkedserver @server = N'S3', @srvproduct=N'SQLSRV', @provider=N'SQLNCLI', @datasrc=N'25.75.178.66\REDMI'
 /* For security reasons the linked server remote logins password is changed with ######## */
